...
//  QuickNote
//
//  Created by Gwendal on 20/02/2021.
//
...
let PLACEHOLDER_SEARCH = NSLocalizedString("PLACEHOLDER_SEARCH", comment: "")

let ACTION_BACK = NSLocalizedString("ACTION_BACK", comment: "")
let ACTION_CANCEL = NSLocalizedString("ACTION_CANCEL", comment: "")
let ACTION_YES = NSLocalizedString("ACTION_YES", comment: "")
